...
INSERT INTO `role` VALUES (1, '学生', now(), now());
INSERT INTO `role` VALUES (2, '教师', now(), now());
INSERT INTO `role` VALUES (3, '管理员', now(), now());
...
INSERT INTO `user` VALUES (1, 'admin', '$2a$10$YmZg6KFPsMVUyWzsxiNgOun7SYoKW1FiAqFvaqnehx2fj0xh5geSa', '张三', '男', 3, 'admin@qq.com', '15648768888', 'http://localhost:8080/dfs/profile-pictures/default.jpg', now(), now());
